      ...
      <div className="container relative z-10">
        ...
        <div className="max-w-lg mx-auto">
          <h1 className="font-serif text-xl md:text-3xl text-center mt-8 tracking-wide">
            Hi there I'm <span className="tracking-widest bg-gradient-to-r from-emerald-300 to-sky-400 text-transparent bg-clip-text text-3xl md:text-5xl">Rohan Sonawane</span> 👋
          </h1>
