        ...
        <div className="mt-20 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
            ...
            <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
              ...
              />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-10 rounded-full  after:content-[''] after:absolute after:inset-0 after:outline after:outline-2 after:-outline-2 after:rounded-full after:gray-950/30">
                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-emerald-300 to-sky-400 -z-20 animate-ping [animation-duration:2sec]"></div>
